...
# Additive model: rainfall + maximum temperature + population size
...
mlemur_additive_0923 <- nimbleCode( {
...
# Compile model
model_mlemur_additive_0923 <- nimbleModel(code = mlemur_additive_0923, constants = nimble_constants, data = nimble_data,inits = inits())
...
# Run model
run_mlemur_additive_0923 <- nimbleMCMC(model = model_mlemur_additive_0923,
                                       monitors = params,
