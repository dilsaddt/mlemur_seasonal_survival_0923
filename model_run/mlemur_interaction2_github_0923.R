...
# Interaction model II: maximum temperature*population size
...
mlemur_interactionII_0923 <- nimbleCode( {
...
# Compile model
model_mlemur_interactionII_0923 <- nimbleModel(code = mlemur_interactionII_0923, constants = nimble_constants, data = nimble_data,inits = inits())
...
# Run model
run_mlemur_interactionII_0923 <- nimbleMCMC(model = model_mlemur_interactionII_0923,
                                            monitors = params,
